...
even after adversarial stress-testing gpt-oss-120b - see the session notes
...
DATA_PATH = Path(__file__).parent / "labeled_dataset.json"
CHECKPOINT_DIR = Path(__file__).parent / "models" / "router-distilbert"
